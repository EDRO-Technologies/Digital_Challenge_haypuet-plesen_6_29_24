...
class ScheduleParser:
    ...
    def _parse_complex_subject_item(self, day: str, pair_num: Any, subject1: Any, subject2: Any, teacher: Any, group: str) -> List[Dict]:
    ...
    def to_flat_json(self, filename: str = 'schedule.json') -> str:
...
if __name__ == "__main__":
    parser = ScheduleParser("ИСиТ.xlsx")
